...
import { SearchReservationArg } from "src/app/shared/scheduler/searchreservationargs";
...
export class ReservationService {
  ...
  getReservations(args: ChangeReservationArg): Observable<object> {
    ...
    this.getAllBoxs().subscribe(resultat => {
    });
  ...
  public getPisteHours(): RoomDto[] {
    const r = new Array<RoomDto>();
    let room: RoomDto;

    room = new RoomDto();
    room.roomId = 6;
    room.roomNumber = '6h - 7h';
    room.roomTypeName = 'piste';
    r.push(room);

    room = new RoomDto();
    room.roomId = 7;
    room.roomNumber = '7h - 8h';
    room.roomTypeName = 'piste';
    r.push(room);

    room = new RoomDto();
    room.roomId = 8;
    room.roomNumber = '8h - 9h';
    room.roomTypeName = 'piste';
    r.push(room);

    room = new RoomDto();
    room.roomId = 9;
    room.roomNumber = '9h - 10h';
    room.roomTypeName = 'piste';
    r.push(room);

    room = new RoomDto();
    room.roomId = 10;
    room.roomNumber = '10h - 11h';
    room.roomTypeName = 'piste';
    r.push(room);

    room = new RoomDto();
    room.roomId = 11;
    room.roomNumber = '11h - 12h';
    room.roomTypeName = 'piste';
    r.push(room);

    room = new RoomDto();
    room.roomId = 12;
    room.roomNumber = '12h - 13h';
    room.roomTypeName = 'piste';
    r.push(room);
  ...
  private getAllBoxs() {
    return this.httpService.get(apiBox);
  }
