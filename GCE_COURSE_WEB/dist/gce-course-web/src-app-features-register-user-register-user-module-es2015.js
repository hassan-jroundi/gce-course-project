...
/* harmony import */ var src_app_core_services_user_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/core/services/user-data.service */ "./src/app/core/services/user-data.service.ts");
...
function RegisterUserComponent_div_13_p_message_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 25);
} }
function RegisterUserComponent_div_13_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r993.userform.controls["name"].errors["required"]);
} }
function RegisterUserComponent_div_19_p_message_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 28);
} }
function RegisterUserComponent_div_19_p_message_2_Template(rf, ctx) { if (rf & 1) {
...
function RegisterUserComponent_div_19_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r994.userform.controls["password"].errors["required"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r994.userform.controls["password"].errors["minlength"]);
} }
function RegisterUserComponent_div_25_p_message_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 32);
} }
function RegisterUserComponent_div_25_p_message_2_Template(rf, ctx) { if (rf & 1) {
...
function RegisterUserComponent_div_25_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r995 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r995.userform.controls["emailId"].errors["required"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r995.userform.controls["emailId"].errors["email"]);
} }
function RegisterUserComponent_div_28_p_message_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 36);
} }
function RegisterUserComponent_div_28_p_message_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 37);
} }
function RegisterUserComponent_div_28_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 8);
    ...
    const ctx_r996 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r996.userform.controls["birthDate"].errors["required"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx_r996.userform.controls["birthDate"].errors["invalidBirthDate"]);
} }
class RegisterUserComponent {
    constructor(userService, router, fb, toastService) {
    ...
    onClickRegisterUser() {
        let isRegistered = this.userService.addUser(this.userform.controls["name"].value, this.userform.controls["password"].value, this.userform.controls["emailId"].value, this.userform.controls["birthDate"].value);
        if (isRegistered) {
...
RegisterUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterUserComponent, selectors: [["app-register-user"]], decls: 37, vars: 8, consts: [[1, "user-regisration"], [1, "p-grid", "p-nogutter", "p-justify-center", "p-align-center", 2, "height", "100%"], [1, "p-xl-3", "p-lg-6", "p-md-8", "p-sm-10"], [3, "formGroup", "ngSubmit"], ["header", "User Registration"], [1, "p-grid", "p-justify-center", "p-align-center"], [1, "p-xl-6", "p-lg-6", "p-md-8", "p-sm-10"], ["src", "assets/images/logo-large.png", "alt", "", 1, "login-logo"], [1, "p-col-12"], [1, "ui-inputgroup"], [1, "ui-inputgroup-addon"], [1, "fa", "fa-user"], ["id", "float-input-username", "type", "text", "size", "30", "pInputText", "", "formControlName", "name", "placeholder", "user name", "required", ""], ["class", "p-col-12", 4, "ngIf"], [1, "fa", "fa-key"], ["id", "float-input-password", "type", "password", "size", "30", "pInputText", "", "formControlName", "password", "placeholder", "password", "required", ""], [1, "fa", "fa-at"], ["id", "float-input-emailid", "type", "email", "size", "30", "pInputText", "", "formControlName", "emailId", "placeholder", "Email Id", "required", ""], ["formControlName", "birthDate", "placeholder", "Birth date", "dateFormat", "dd/mm/yy", 3, "showIcon"], [1, "p-grid"], [1, "p-col-6"], ["pButton", "", "type", "button", "label", "Register", 1, "ui-button-raised", 3, "disabled", "click"], ["pButton", "", "type", "button", "label", "Login", 1, "ui-button-raised", 3, "click"], [1, "extra-page-footer"], ["severity", "error", "text", "User name is required", 4, "ngIf"], ["severity", "error", "text", "User name is required"], ["severity", "error", "text", "Password is required", 4, "ngIf"], ["severity", "error", "text", "Minimum 6 characters required.", 4, "ngIf"], ["severity", "error", "text", "Password is required"], ["severity", "error", "text", "Minimum 6 characters required."], ["severity", "error", "text", "Email is required", 4, "ngIf"], ["severity", "error", "text", "Email is invalid", 4, "ngIf"], ["severity", "error", "text", "Email is required"], ["severity", "error", "text", "Email is invalid"], ["severity", "error", "text", "Birthdate is required", 4, "ngIf"], ["severity", "error", "text", "Minimum age should be 10 years.", 4, "ngIf"], ["severity", "error", "text", "Birthdate is required"], ["severity", "error", "text", "Minimum age should be 10 years."]], template: function RegisterUserComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterUserComponent_Template_button_click_31_listener() { return ctx.onClickRegisterUser(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](32, "div", 20);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](33, "button", 22);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterUserComponent_Template_button_click_33_listener() { return ctx.onClickGoToLogin(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterUserComponent, [{
    ...
    }], function () { return [{ type: src_app_core_services_user_data_service__WEBPACK_IMPORTED_MODULE_5__["UserDataService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }, { type: src_app_core_services_toast_service__WEBPACK_IMPORTED_MODULE_3__["ToastService"] }]; }, null); })();
...
/* harmony import */ var src_app_features_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/features/register-user/register-user.component */ "./src/app/features/register-user/register-user.component.ts");
/* harmony import */ var src_app_features_register_user_register_user_routing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/features/register-user/register-user.routing */ "./src/app/features/register-user/register-user.routing.ts");
...
RegisterUserModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: RegisterUserModule });
RegisterUserModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function RegisterUserModule_Factory(t) { return new (t || RegisterUserModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            src_app_features_register_user_register_user_routing__WEBPACK_IMPORTED_MODULE_3__["RegisterUserRoutingModule"],
            src_app_app_common_module__WEBPACK_IMPORTED_MODULE_4__["AppCommonModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](RegisterUserModule, { declarations: [src_app_features_register_user_register_user_component__WEBPACK_IMPORTED_MODULE_2__["RegisterUserComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        src_app_features_register_user_register_user_routing__WEBPACK_IMPORTED_MODULE_3__["RegisterUserRoutingModule"],
        src_app_app_common_module__WEBPACK_IMPORTED_MODULE_4__["AppCommonModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterUserModule, [{
...
class RegisterUserRoutingModule {
}
RegisterUserRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: RegisterUserRoutingModule });
RegisterUserRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function RegisterUserRoutingModule_Factory(t) { return new (t || RegisterUserRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
        _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](RegisterUserRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterUserRoutingModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
...
//# sourceMappingURL=src-app-features-register-user-register-user-module-es2015.js.map